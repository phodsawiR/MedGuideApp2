  ...
  const handlePasteImport = async () => {
    try {
      ...
      dataArray.forEach((item) => {
        ...
        // ⭐ แก้ไข: แปลง \n ให้เป็น Enter จริงๆ ก่อนเริ่มงาน (ย้ายมาบรรทัดแรก)
        fixedSummary = fixedSummary.replace(/\\n/g, "\n");

        fixedSummary = fixedSummary
          // 1. แก้ |n| หรือ | n | ระหว่างตาราง
          .replace(/\|\s*n\s*\|/g, "|\n|")

          // 2. แก้ n| หน้าหัวตาราง (เพิ่มดัก : และ ) เพื่อความชัวร์)
          .replace(/(^|[\s\r\n>:)}])n\|/g, "$1\n|")
          ...
          <div className="p-6 space-y-8 flex-1 overflow-y-auto">
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 flex flex-col gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer" // 👈 แก้บรรทัดนี้ครับ (สำคัญมาก!)
